...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('crm_contactrelationship', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contact_from', self.gf('django.db.models.fields.related.ForeignKey')(related_name='relates_to', to=orm['crm.Contact'])),
            ('contact_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_to', to=orm['crm.Contact'])),
            ('relationship', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Relationship'])),
        ))
        db.send_create_signal('crm', ['ContactRelationship'])
