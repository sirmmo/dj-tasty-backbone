...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Interaction.communication'
        db.alter_column('crm_interaction', 'communication', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Interaction.contact_from'
        db.alter_column('crm_interaction', 'contact_from_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Contact']))


    def backwards(self, orm):
        
        # Changing field 'Interaction.communication'
        db.alter_column('crm_interaction', 'communication', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Interaction.contact_from'
        db.alter_column('crm_interaction', 'contact_from_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.UserProfile']))
