...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CompanyArea'
        db.create_table('crm_companyarea', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Company'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('crm', ['CompanyArea'])

        # Adding field 'Contact.area'
        db.add_column('crm_contact', 'area', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.CompanyArea'], null=True, blank=True), keep_default=False)

        # Deleting field 'UserProfile.area'
        db.delete_column('crm_userprofile', 'area_id')

        # Adding field 'UserProfile.contact'
        db.add_column('crm_userprofile', 'contact', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Contact'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CompanyArea'
        db.delete_table('crm_companyarea')

        # Deleting field 'Contact.area'
        db.delete_column('crm_contact', 'area_id')

        # Adding field 'UserProfile.area'
        db.add_column('crm_userprofile', 'area', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Area'], null=True, blank=True), keep_default=False)

        # Deleting field 'UserProfile.contact'
        db.delete_column('crm_userprofile', 'contact_id')
    ...
    models = {
        ...
        'crm.userprofile': {
            ...
            'contact': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['crm.Contact']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
