...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('crm_interactiontype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal('crm', ['InteractionType'])

        # Adding model 'Interaction'
        db.create_table('crm_interaction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contact_from', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.UserProfile'])),
            ('contact_to', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Contact'])),
            ('means', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.InteractionType'])),
        ...
        db.send_create_signal('crm', ['Interaction'])


    def backwards(self, orm):
        
        # Deleting model 'InteractionType'
        db.delete_table('crm_interactiontype')
    ...
    models = {
        ...
        'crm.interaction': {
            ...
            'contact_from': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['crm.UserProfile']"}),
            'contact_to': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['crm.Contact']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
